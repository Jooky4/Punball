...
func collide_with_enemy(collider) -> void:
	AM.play_sound("hit_enemy_small_crumbling_ball")
	...
	collider.deal_damage((damage_ball + damage_ball_plus) * ElementsManager.laser_modifier, ElementsManager.color_elements["LASER"])
