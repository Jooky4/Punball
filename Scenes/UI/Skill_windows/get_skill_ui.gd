...
var skill_discription = {
	...
	"Огненный шар" : "Огненный шар: наносит урон и поджигает врагов",
	"Шар-бомба" : "Шар бомба: наносит урон по области",
	"Бомба-заморозка" : "Бомба холода: наносит урон по области и может заморозить врага",
	"Молния: комбо" : "Выпускает три молнии каждые 40 комбо",
	...
	"Кумулятивный шар" : "Мощный шар: наносит врагу огромный урон один раз",
	"Шар удара в спину" : "Шар сюрикен: наносит врагам больше урона при атаке со спины",
	"Шар убийца" : "Шар убийца: имеет небольшой шанс мгновенно убить врага",
	...
	"Шар молний" : "Шар молний: поражает трех случайных врагов",
	...
	"Рассыпающийся шар" : "Рассыпающийся шар: распадается на 4 маленьких шарика",
	"Вертикальный лазерный шар" : "Лазерный шар: наносит врагам урон вертикальным лазерным лучом",
	"Горизонтальный лазерный шар" : "Лазерный шар: наносит врагам урон горизонтальным лазерным лучом",
	"Повелитель лазера" : "Урон от лазера повышается. Лазеры стреляют в 4 направлениях",
	"Шар ракета" : "Шар ракета: выпускает ракеты в самого слабого врага",
	"Повелитель атома" : "Урон от ракет повышен. +1 ракета при запуске ракет",
	"Бурящий шар" : "Бурящий шар: пронзает всех врагов",
	...
	"Повелитель молний" : "Урон от молний повышен. Молнии бьют еще по 2 целям",
	...
	"Ракета смерти" : "Создает множество самонаводящихся ракет при гибели врага",
