...
var skill_discription = {
	"Шар-заморозка" : "Добавляет шар холода, который имеет 10% шанс заморозить врага",
	"Лед: комбо" : "Выпускает ледяной конус в случайного врага каждые 40 комбо",
	"Ядерная: комбо" : "Выпускает ракету в самого слабого врага каждые 40 комбо",
	...
	"Огненный шар" : "Добавляет огненный шар, который наносит урон и поджигает врагов",
	"Шар-бомба" : "Добавляет бомбу, наносящую урон по области",
	"Бомба-заморозка" : "Добавляет бомбу холода, наносящую урон по области. Может заморозить врага",
	"Молния: комбо" : "Пускает три молнии каждые 40 комбо",
	"Лазер: комбо" : "Выпускает лазерный шар в случайного врага каждые 40 комбо",
	"Огонь: комбо" : "Выпускает огненный шар в случайного врага каждые 40 комбо",
	"Кумулятивный шар" : "Добавляет шар, который наносит врагу мощный урон один раз",
	"Шар удара в спину" : "Добавляет шар, который наносит врагам больше урона при атаке со спины",
	"Шар убийца" : "Добавляет шар, 
с небольшим шансом  мгновенно убивающий врага",
	...
	"Шар молний" : "Добавляет шар молнии, который поражает трех случайных врагов",
	...
	"Рассыпающийся шар" : "Добавляет шар, распадающийся при попадании на 4 маленьких шарика",
	"Вертикальный лазерный шар" : "Добавляет шар, наносящий врагам урон вертикальным лазерным лучом",
	"Горизонтальный лазерный шар" : "Добавляет шар, наносящий врагам урон горизонтальным лазерным лучом",
	"Повелитель лазера" : "Урон от лазера повышается. Лазеры стреляют в 4х направлениях",
	"Шар ракета" : "Добавляет шар, который выпускает ракеты в самого слабого врага",
	"Повелитель атома" : "Урон от ракет повышен. +1 ракета при запуске ракет",
	"Бурящий шар" : "Добавляет шар, который пронзает всех врагов",
	...
	"Молния смерти" : "При гибели врага три молнии бьют случайных противников",
	"Бомба смерти" : "Наносит урон по области вокруг убитого врага",
	"Лазер смерти" : "При гибели врага, выпускает от него горизонтальный лазер",
	"Ракета смерти" : "Создает множество самонаводящихся ракет в при гибели врага",
