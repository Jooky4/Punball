...
var regular = ["Шар-заморозка", "Усиление обычного шара", "Огненный шар", "Усиление особого шара"]
var rare = ["Шар молний", "Рассыпающийся шар", "Шар-бомба", "Прибавка ОЗ", "Бомба-заморозка"]
var epic = ["Усиление атаки", "Молния смерти", "Холод смерти", "Бомба смерти"]
var legendary = ["Повелитель молний", "Повелитель льда", "Повелитель огня"]
var skills = []
