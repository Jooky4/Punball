...
var REGULAR_WINDOW = preload("res://Scenes/UI/Skill_windows/regular_window.tscn")
var RARE_WINDOW = preload("res://Scenes/UI/Skill_windows/rare_window.tscn")
