...
var rare = ["Огненный шар", "Шар-бомба", "Бомба-заморозка", "Молния: комбо", "Лазер: комбо", "Огонь: комбо", "Шар ракета", "Кумулятивный шар", "Шар удара в спину", "Шар убийца", "Технология: комбо с тыла", "Технология: комбо с фронта", "Усиление особого шара", "Усиление атаки", "Комбо: скидка", "Суперначало"]
